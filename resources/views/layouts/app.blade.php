        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                @if (Auth::guest())
                    ...
                    <li><a href="{{ url('/contacts') }}">Tools</a></li>                    
                    <li><a href="{{ url('/contacts') }}">Procedures</a></li>                    
                    @endif
                    ...
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              ...
                              <li><a href="{{ url('/logout') }}"><i class="fa fa-btn fa-power-off"></i></a></li>
...
<p class="text-center">&copy; 2016 iDevelopment</p>
    <!-- JavaScripts -->
